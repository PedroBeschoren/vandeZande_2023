...
insect_ps_soil_l<- #NA to "" also for list of separated pot/field
...
sample_names_sorted<-sort(sample_names(insect_ps))
otu_table(insect_ps) <- otu_table(insect_ps)[, sample_names_sorted]

field_sample_names_sorted<-sort(sample_names(insect_ps_soil_l$Field))
otu_table(insect_ps_soil_l$Field) <- otu_table(insect_ps_soil_l$Field)[, field_sample_names_sorted]

pot_sample_names_sorted<-sort(sample_names(insect_ps_soil_l$Pot))
otu_table(insect_ps_soil_l$Pot) <- otu_table(insect_ps_soil_l$Pot)[, pot_sample_names_sorted]
