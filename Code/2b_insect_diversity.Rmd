...
library(car)
leveneTest((shannon) ~ Treatment*Soil*as.factor(Observation), data = taxon_diversity) 

#two-way anova, shanon diversity index
  tx <- with(taxon_diversity, interaction(Treatment,Soil,as.factor(Observation))) #needed for tukey to test interaction
  ...
  save_as_docx(anova_test_ft,
               path = "./Results/shannon_anova_insect.docx")
